...
public class Main {
    ...
    public static void main(String[] args) throws IOException{
        StudentRepo rep=new StudentRepo(new StudentValidator(),"C:\\Users\\Diana\\Facultate\\Year3\\SSVV\\Lab2\\Maven project\\SSVV\\MaxPointsParticipants\\src\\main\\java\\MaxPointsParticipantsMV\\studenti.xml");
        TemeRepo repo=new TemeRepo(new TemeValidator(),"C:\\Users\\Diana\\Facultate\\Year3\\SSVV\\Lab2\\Maven project\\SSVV\\MaxPointsParticipants\\src\\main\\java\\MaxPointsParticipantsMV\\teme.xml");
